...
public class StartApplicationServerCommand extends CommandWithMetadata {

    private static final Logger logger= LoggerFactory.getLogger(StartApplicationServerCommand.class.getName());

    private Provider<CamelContext> serverProvider;

    @Inject
    public StartApplicationServerCommand(Provider<CamelContext> serverProvider) {
        super(createMetadata());
        this.serverProvider = serverProvider;
    }

    private static CommandMetadata createMetadata() {
        return CommandMetadata.builder(StartApplicationServerCommand.class).description("Starts Application Server..").build();
    }
